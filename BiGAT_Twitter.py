...
class Net(th.nn.Module):
    def __init__(self,in_feats,hid_feats,out_feats):
        ...
        self.TDrumorGAT = TDrumorGAT(in_feats, hid_feats, out_feats)
        self.BUrumorGAT = BUrumorGAT(in_feats, hid_feats, out_feats)
...
def train_GAT(treeDic, x_test, x_train,TDdroprate,BUdroprate,lr, weight_decay,patience,n_epochs,batchsize,dataname,iter):
    model = Net(5000,64,64).to(device)
    BU_params=list(map(id,model.BUrumorGAT.conv1.parameters()))
    BU_params += list(map(id, model.BUrumorGAT.conv2.parameters()))
    base_params=filter(lambda p:id(p) not in BU_params,model.parameters())
    optimizer = th.optim.Adam([
        {'params':base_params},
        {'params':model.BUrumorGAT.conv1.parameters(),'lr':lr/5},
        {'params': model.BUrumorGAT.conv2.parameters(), 'lr': lr/5}
    ...
    for epoch in range(n_epochs):
        ...
        early_stopping(np.mean(temp_val_losses), np.mean(temp_val_accs), np.mean(temp_val_F1), np.mean(temp_val_F2),
                       np.mean(temp_val_F3), np.mean(temp_val_F4), model, 'BiGAT', dataname)
...
def main(obj):
    ...
    for iter in range(iterations):
        ...
        train_losses, val_losses, train_accs, val_accs0, accs0, F1_0, F2_0, F3_0, F4_0 = train_GAT(treeDic,
                                                                                                   fold0_x_test,
                                                                                                   fold0_x_train,
                                                                                                   ...
                                                                                                   datasetname,
                                                                                                   iter)
        train_losses, val_losses, train_accs, val_accs1, accs1, F1_1, F2_1, F3_1, F4_1 = train_GAT(treeDic,
                                                                                                   fold1_x_test,
                                                                                                   fold1_x_train,
                                                                                                   ...
                                                                                                   datasetname,
                                                                                                   iter)
        train_losses, val_losses, train_accs, val_accs2, accs2, F1_2, F2_2, F3_2, F4_2 = train_GAT(treeDic,
                                                                                                   fold2_x_test,
                                                                                                   fold2_x_train,
                                                                                                   TDdroprate,BUdroprate, lr,
                                                                                                   weight_decay,
                                                                                                   ...
                                                                                                   datasetname,
                                                                                                   iter)
        train_losses, val_losses, train_accs, val_accs3, accs3, F1_3, F2_3, F3_3, F4_3 = train_GAT(treeDic,
                                                                                                   fold3_x_test,
                                                                                                   fold3_x_train,
                                                                                                   TDdroprate,BUdroprate, lr,
                                                                                                   weight_decay,
                                                                                                   ...
                                                                                                   datasetname,
                                                                                                   iter)
        train_losses, val_losses, train_accs, val_accs4, accs4, F1_4, F2_4, F3_4, F4_4 = train_GAT(treeDic,
                                                                                                   fold4_x_test,
                                                                                                   fold4_x_train,
                                                                                                   TDdroprate,BUdroprate, lr,
                                                                                                   weight_decay,
